...
읽는 순서: [비전](docs/ai/00-vision.md) → [아키텍처](docs/ai/01-architecture.md) → [core 스펙](docs/ai/02-core-spec.md) → [앱 스펙](docs/ai/03-app-spec.md) → [로드맵](docs/ai/04-roadmap.md) → [결정 기록](docs/ai/05-decisions.md)
